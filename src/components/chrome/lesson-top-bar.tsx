    ...
    >
      <div className="relative h-20 w-full">
        <button
          ...
          className="absolute left-4 top-1/2 grid size-10 -translate-y-1/2 place-items-center rounded-full text-muted transition-colors hover:bg-default hover:text-foreground sm:left-8 lg:left-16 xl:left-20"
        >
          <CloseIcon />
        </button>
